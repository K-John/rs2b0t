...
### Script travel OD (clues / gathering / quests)

**Live harness:** `tools/nav-script-travel-live.ts`  
...
HEADED=0 SEGMENT=clues LIMIT=40 BUDGET_S=120 USE_TELEPORTS=0 bun tools/nav-script-travel-live.ts

# Tele + charged jewellery seed/top-up
HEADED=0 SEGMENT=gathering-all LIMIT=0 BUDGET_S=240 USE_TELEPORTS=1 bun tools/nav-script-travel-live.ts

HEADED=1 SEGMENT=fishing LIMIT=0 bun tools/nav-script-travel-live.ts
HEADED=1 SEGMENT=quests LIMIT=50 OFFSET=0 bun tools/nav-script-travel-live.ts
```
