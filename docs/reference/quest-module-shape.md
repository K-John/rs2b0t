...
| Directory | Job |
|---|---|
| [`src/bot/engines/quests/engine/`](../../src/bot/engines/quests/engine/) | runs quests: queue, snapshot, provisioning, watchdog |
| [`src/bot/engines/quests/defs/`](../../src/bot/engines/quests/defs/) | one module per quest — the decisions |
| [`src/bot/engines/quests/exec/`](../../src/bot/engines/quests/exec/) | the primitives a step is built from |
...
`wait`, `done` (see [`engine/types.ts`](../../src/bot/engines/quests/engine/types.ts)) — and
[`executeStep`](../../src/bot/engines/quests/exec/steps.ts) knows how to perform each kind.
