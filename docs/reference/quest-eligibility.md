...
[`EligibilityEvaluator`](../../src/bot/engines/quests/EligibilityEvaluator.ts) reports each quest
as `DONE`, `READY`, or `BLOCKED` **with reasons**, combining
[`RequirementChecker`](../../src/bot/engines/quests/RequirementChecker.ts) (quest points, skill
levels, prerequisite quests) and [`ItemChecker`](../../src/bot/engines/quests/ItemChecker.ts)
(inventory and bank).
...
([`supplies.ts`](../../src/bot/engines/quests/defs/elementalworkshop/supplies.ts)):
