...
[`engine/types.ts`](../../src/bot/engines/quests/engine/types.ts) read them.
[`defs/watchtower/journal.ts`](../../src/bot/engines/quests/defs/watchtower/journal.ts) is
...
[`engine/provisioning.ts`](../../src/bot/engines/quests/engine/provisioning.ts) assembles what a
...
(`PROVISION_BANK`) — both in [`QuestEngine.ts`](../../src/bot/engines/quests/engine/QuestEngine.ts).

## The queue and the watchdog

[`QuestEngine`](../../src/bot/engines/quests/engine/QuestEngine.ts) runs quests in order,
...
step that cannot advance. `ProgressWatchdog` ([`engine/watchdog.ts`](../../src/bot/engines/quests/engine/watchdog.ts))
is what notices.
