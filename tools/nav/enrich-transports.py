...
def main() -> None:
    ...
    parser.add_argument("--transports-output", type=Path, default=Path("src/bot/engines/nav/data/transports.json"))
    parser.add_argument("--stairs-output", type=Path, default=Path("src/bot/engines/nav/data/stairEdges.json"))
