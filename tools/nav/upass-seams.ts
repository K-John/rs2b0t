...
const ROUTE: [string, NavPoint][] = [
    ...
    ['past cage 3268 east', { x: 2404, z: 9619, level: 0 }],
    ['past cage 3268 west', { x: 2380, z: 9618, level: 0 }],
    ['area 1 tunnel mouth', { x: 2371, z: 9666, level: 0 }],
    ['tunnel exit pre-unicorn', { x: 2401, z: 9610, level: 0 }],
    ['tunnel exit post-unicorn', { x: 2376, z: 9610, level: 0 }],
    ['boulder', { x: 2396, z: 9596, level: 0 }],
    ['mud pile exit', { x: 2418, z: 9674, level: 0 }],
    ['east of cage 3268 a', { x: 2405, z: 9620, level: 0 }],
    ['east of cage 3268 b', { x: 2404, z: 9621, level: 0 }],
    ['east of cage 3268 c', { x: 2404, z: 9618, level: 0 }],
    ['west of cage 3268 a', { x: 2379, z: 9619, level: 0 }],
    ['west of cage 3268 b', { x: 2381, z: 9619, level: 0 }],
    ['tunnel row north', { x: 2400, z: 9616, level: 0 }],
    ['tunnel row east', { x: 2407, z: 9613, level: 0 }],
    ['boulder stand N', { x: 2396, z: 9598, level: 0 }],
    ['boulder stand E', { x: 2398, z: 9596, level: 0 }],
    ['boulder stand W', { x: 2394, z: 9596, level: 0 }],
    ['boulder stand S', { x: 2396, z: 9593, level: 0 }]
];
