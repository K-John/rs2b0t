...
export class QuestEngine implements Task {
    ...
    private readPlayerState(): PlayerState {
        ...
        // Why: what the account has finished is read from every known quest, not only the ones with a module.
        // A prerequisite whose own quest has no module yet — Biohazard ahead of Underground Pass — would
        // otherwise be unsatisfiable, and the quest it gates would report BLOCKED forever.
