...
export const PC_TILE = {
    ...
    REHNISON_TED: new Tile(2531, 3330, 0),
    REHNISON_STAIRS: new Tile(2528, 3332, 0),
    REHNISON_TOP: new Tile(2528, 3332, 1),
    MILLI: new Tile(2529, 3331, 1),
    PLAGUE_DOOR: new Tile(2533, 3273, 0),
    CLERK: new Tile(2530, 3316, 0),
    BRAVEK_DOOR: new Tile(2531, 3314, 0),
    BRAVEK: new Tile(2535, 3314, 0),
    BARREL: new Tile(2534, 3269, 0),
    HOUSE_STAIRS_DOWN: new Tile(2536, 3269, 0),
