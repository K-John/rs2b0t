...
// Why: this is the quest's side of Alfred Grimhand's Barcrawl — the tour itself is a miniquest of its own and lives in `src/bot/engines/quests/barcrawl/`, where the standalone script runs it too.
