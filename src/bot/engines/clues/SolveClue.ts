...
import { ClueExecutor } from '#/bot/engines/clues/ClueExecutor.js';
import { CASKET_IDS, CLUE_DB } from '#/bot/engines/clues/data/cluedb.js';
import { ensureCoordTools, hasAllTrio, hasCoordClueHeld } from '#/bot/engines/clues/AcquireTools.js';
import { SPADE_NAME, trailKit } from '#/bot/engines/clues/data/toolAcquire.js';
import { COORD_TOOL_SLOTS, trailFoodTarget, weaponNeeded } from '#/bot/engines/clues/packPlan.js';
import { isTeleportItem, teleportKitFor, type TeleportKit } from '#/bot/engines/clues/teleportKit.js';
import {
    ENTRANA_RESTRICTED_GEAR_RE,
    namesHaveEntranaRestrictedGear
} from '#/bot/engines/nav/exec/specialCrossing.js';
import { snapshotWorldState } from '#/bot/engines/nav/worldStateLive.js';
