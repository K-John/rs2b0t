...
import { identifyStep } from '#/bot/engines/clues/ClueLogic.js';
import { ClueTrace, pushTraceRing } from '#/bot/engines/clues/ClueTrace.js';
import { CASKET_IDS, CLUE_DB } from '#/bot/engines/clues/data/cluedb.js';
import { challengeAnswer } from '#/bot/engines/clues/data/challengeAnswers.js';
import { clueGate } from '#/bot/engines/clues/data/clueGates.js';
import { KILL_ANCHORS } from '#/bot/engines/clues/data/killAnchors.js';
import { ensureSpade, ensureCoordTools, ensureExtraItems, ensureGateItems } from '#/bot/engines/clues/AcquireTools.js';
import { SPADE_NAME } from '#/bot/engines/clues/data/toolAcquire.js';
import { fightGuardian, sustainUntil } from '#/bot/engines/clues/Guardian.js';
import { PuzzleBox } from '#/bot/engines/clues/PuzzleBox.js';
import { casketRewardSlots } from '#/bot/engines/clues/packPlan.js';
import type { ClueRow, ClueStep } from '#/bot/engines/clues/types.js';
import type { NavPoint } from '#/bot/engines/nav/PathFinder.js';
import { talkThrough } from '#/bot/engines/quests/exec/primitives.js';
