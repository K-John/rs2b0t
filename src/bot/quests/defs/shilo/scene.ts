...
/**
 * Like `driveDialog`, but abandons rather than guessing. Several of this quest's
 * prompts have a harmful or wasteful second option, and the mound and gallows
 * prompts both put the refusal first.
 */
...
/**
 * Walk to a stand, act on a loc, then answer whatever prompt it raised. Most of
 * this quest's world interactions are exactly this shape.
 */
...
/**
 * Use a carried item on a loc, then answer whatever prompt it raised. The engine
 * routes most of this quest's item chain through `oplocu`, not through an op.
 */
