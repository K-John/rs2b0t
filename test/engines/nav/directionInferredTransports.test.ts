...
import transports from '#/bot/engines/nav/data/transports.json';
import { specialCrossingAt } from '#/bot/engines/nav/data/specialCrossings.js';
import type { TransportEdgeData } from '#/bot/engines/nav/PathFinder.js';
import { specialRequiresAt } from '#/bot/engines/nav/specialRequires.js';
import { mageArenaBarrierEdges } from '#/bot/engines/nav/travelCatalog.js';
