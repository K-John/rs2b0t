...
import { parseLcCoord, lcCoord } from '#/bot/engines/nav/geometry/lcCoord.js';
import {
    SPIRIT_TREE,
    GLIDER_PAD,
    ENTRANA_LAND,
...
import { essenceExitEdges } from '#/bot/engines/nav/essenceExit.js';
import { specialCrossingForTransport } from '#/bot/engines/nav/data/specialCrossings.js';
