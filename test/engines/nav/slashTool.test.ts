...
import {
    ...
    WEB_SLASH_NO_BLADE,
    WEB_SLASH_SUCCESS
} from '#/bot/engines/nav/slashTool.js';
import { meetsRequires } from '#/bot/engines/nav/requires.js';
import { itemsRequiredByWaypoints, missingItemsForPath } from '#/bot/engines/nav/bankPlan.js';
import { virtualizeWithItems } from '#/bot/engines/nav/virtualState.js';
import { emptyWorldStateData, worldStateFromData } from '#/bot/engines/nav/worldStateData.js';
import type { Waypoint } from '#/bot/engines/nav/PathFinder.js';
import { agilityShortcutEdges } from '#/bot/engines/nav/travelCatalog.js';
...
describe('elkoy maze catalog', () => {
    test('dual Elkoy portal edges require Tree Gnome Village started', async () => {
        const { elkoyMazeEdges } = await import('#/bot/engines/nav/travelCatalog.js');
