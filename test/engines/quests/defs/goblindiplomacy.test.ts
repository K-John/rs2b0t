...
import { decide, GOBLIN_DIPLOMACY_COIN_TARGET, GOBLIN_DIPLOMACY_QUEST_COIN_RESERVE, GOBLIN_MAIL_FOOD_RESTOCK_FLOOR, GOBLIN_MAIL_FOOD_TARGET, goblindiplomacy, goblinMailGatherStep } from '#/bot/engines/quests/defs/goblindiplomacy.js';
