...
import { SV_ITEM, inDolmenRoom, shiloArea } from '#/bot/engines/quests/defs/shilo/areas.js';
import { SV_STAGE, parseShiloJournal } from '#/bot/engines/quests/defs/shilo/journal.js';
import { decide, shilo } from '#/bot/engines/quests/defs/shilo/index.js';
import { evaluate } from '#/bot/engines/quests/EligibilityEvaluator.js';
import { flagValue, hasFlag } from '#/bot/engines/quests/engine/types.js';
import type { QuestProgress, QuestSnapshot } from '#/bot/engines/quests/engine/types.js';
