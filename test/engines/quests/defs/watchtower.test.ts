...
import { CRYSTALS, WT_ITEM, WT_NPC, watchtowerArea } from '#/bot/engines/quests/defs/watchtower/areas.js';
import { WATCHTOWER_STAGE, parseWatchtowerJournal } from '#/bot/engines/quests/defs/watchtower/journal.js';
import { flagValue, hasFlag } from '#/bot/engines/quests/engine/types.js';
import type { QuestSnapshot } from '#/bot/engines/quests/engine/types.js';
import { decide, watchtower } from '#/bot/engines/quests/defs/watchtower/index.js';
