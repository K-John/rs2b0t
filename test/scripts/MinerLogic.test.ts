...
import { desertCampFoodReserveDepleted, desertCampFoodReservedSlots, MINER_FOOD_SETTINGS, minerFoodConfig, minerFoodRestockNeeded, planMinerFoodWithdrawal, shouldEatMinerFood, unsupportedCampOres } from '#/bot/scripts/MinerLogic.js';
