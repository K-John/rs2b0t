...
import rawDoors from '#/bot/nav/data/doors.json';
import { SPECIAL_CROSSINGS, specialCrossingForTransport } from '#/bot/nav/data/specialCrossings.js';
import { arrivalDialogueResolved, shouldSceneStepToTile } from '#/bot/nav/exec/specialCrossing.js';
import { DESERT_MINING_CAMP_REPLACED_DOOR_IDS, DESERT_MINING_CAMP_SCRIPTED_DOOR_IDS } from '#/bot/nav/desertMiningCampDoors.js';
import { allDoorRows, allTransportRows, loadDefaultNavEdges } from '#/bot/nav/loadTransportGraph.js';
...
import { desertMiningCampEdges } from '#/bot/nav/travelCatalog.js';
